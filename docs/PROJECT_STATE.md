...
| Last product-code commit | **`e9e2fc4`** (2026-08-30, D-469 content-gate checks) + the D-470 PII fixes landing after it; the remediation program D-467..D-470 is complete |
...
8 open engineering entries (6 in §4.1, 2 in §4.2). Full evidence per entry:
