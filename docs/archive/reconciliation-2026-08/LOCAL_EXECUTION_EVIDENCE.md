...
> **Reason:** Phase 3A.5 local-execution evidence — every command run against the working tree and its verbatim output. **Superseded by:** the 166-entry register at `docs/reference/reconciliation-2026-08/FINAL_OPEN_WORK_REGISTER.md`.
