...
D-176 and D-177): 1.** Arithmetic, written out because this line has now been wrong three times:
3 open after D-176, **minus** AUD-C-23 and AUD-C-24 (both decided by the user and implemented in
D-177) = **1**. Confirmed by running ROADMAP's anchored `awk`, not by counting the sentence
below. `Open — Phase 0B`: **AUD-F-33** only (deferred by the user's call — detection exists,
mechanism unknown). **AUD-L-01, AUD-L-05, L-08, L-16, C-14, C-15, C-23, C-24 and F-22
are now fixed** — C-14/C-15/L-16 in D-174, L-01/L-05 in D-175, L-08/F-22 in D-176, C-23/C-24 in
D-177 (C-23's live 10-probe re-verification is owed after the next deploy). **AUD-F-16 is
