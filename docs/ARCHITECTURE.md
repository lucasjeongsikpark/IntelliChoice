...
flowchart TB
    ...
    subgraph PKGS["Workspace packages"]
        ...
        CURR["packages/curriculum<br/>taxonomy · shape registry ·<br/>variant gen · §5.8.5 validation (S4)<br/>ai_pipeline · settings (S9)<br/>authored_validation · review_cli<br/>(S20, sympy independent solve)<br/>hint_ladders: 11 hand-authored<br/>canonical shape ladders (S21)<br/>· hint_solution_review (D-251):<br/>PASS/REPAIR/REJECT reviewer,<br/>built but wired to NOTHING until<br/>its falsification run passes"]
